...
class gsp_breaktime_useredit_gsp extends GroovyPage {
...
invokeTag('form','g',38,['url':([resource:userInstance, action:'update']),'method':("PUT"),'enctype':("multipart/form-data")],2)
printHtmlPart(24)
})
...
public static final long LAST_MODIFIED = 1430537990613L
